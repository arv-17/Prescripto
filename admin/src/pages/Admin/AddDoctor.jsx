...
const AddDoctor = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className="m-5 w-full">
      ...
      <div className="bg-white px-8 py-8  rounded border-0 shadow-2xl w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 text-gray-600">
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            ...
            <div className="flex-1 flex flex-col gap-1">
              <p>Education</p>
              <input className="border rounded px-3 py-2" onChange={(e)=>setDegree(e.target.value)} value={degree} type="text" placeholder="Education" required />
            </div>
        ...
        <div className="flex-1 flex flex-col gap-1 text-gray-600">
          ...
          <textarea className="w-full px-4 pt-2 border rounded" onChange={(e)=>setAbout(e.target.value)} value={about} placeholder="write about doctor" rows={5} required />
        </div>

        <button type='submit' className='bg-primary text-white rounded-full px-10 py-3 mt-4 cursor-pointer' >Add Doctor</button>
      </div>
    </form>
  );
};
